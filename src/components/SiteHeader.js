	    ...
	    return (
	    	<Header align="center" p={4} bg="green" color="white">
				...
				<Box mw="800px" mx="auto" pb={3}>
					<H2 f={3} p={3} color="green2">Starter Kit with React, Next.js, and Styled Components with Styled System to get projects going with a design theme, built-in styleguide and&nbsp;browser&nbsp;testing</H2>
				</Box>
			</Header>
	    );
	}
