	    ...
	    return (
	    	<Header align="center" py={5} px={[3,3,4]} bg="base" color="white" position="relative">
				...
				<Box mw="800px" mx="auto" pb={3}>
					...
					<LinkButton py={3} f={3} fontWeight="bold" bg="white" color="blue" href="https://github.com/johnpolacek/styled-starter-basic/archive/master.zip">
						<Box borderRadius="4px" bg="blue" color="white" px={2} mr={3} pt="2px" style={{transform:'rotate(-90deg)'}}>&#8676;</Box>
						<Span pr={2}> Download Starter Project</Span>
					</LinkButton>
				</Box>
			</Header>
	    );
