...
crimson.fontFamilies = {sans:`"Segoe UI", Candara, "Bitstream Vera Sans", "DejaVu Sans", "Bitstream Vera Sans", "Trebuchet MS", Verdana, "Verdana Ref", sans-serif`};
crimson.font = crimson.fontFamilies.sans;
crimson.webfonts = {}
...
forest.fontFamilies = {sans: "Frutiger, \"Frutiger Linotype\", Univers, Calibri, \"Gill Sans\", \"Gill Sans MT\", \"Myriad Pro\", Myriad, \"DejaVu Sans Condensed\", \"Liberation Sans\", \"Nimbus Sans L\", Tahoma, Geneva, \"Helvetica Neue\", Helvetica, Arial, sans-serif"};
forest.font = forest.fontFamilies.sans;
...
lime.fontFamilies = {sans:`"Segoe UI", Candara, "Bitstream Vera Sans", "DejaVu Sans", "Bitstream Vera Sans", "Trebuchet MS", Verdana, "Verdana Ref", sans-serif`};
lime.font = lime.fontFamilies.sans;
lime.webfonts = {}
